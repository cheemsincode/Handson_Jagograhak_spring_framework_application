...
public class ComplaintServiceImpl implements ComplaintService {
	...
	public int registerComplaintDetails(ComplaintBean complaintBean) throws Exception { 
		...
		int res = complaintDaoWrapper.getCustomerByComplaintType(complaintBean.getCustomerName(), complaintBean.getComplaintTypeId());
		if(res == 1) { 
			throw new Exception("The customer has Already submitter a with a same type");
		}
